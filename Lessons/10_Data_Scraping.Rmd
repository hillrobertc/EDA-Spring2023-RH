...
#Modify the dataframe to include the facility name and type as well as the date (as date object) the "!!" tells r to read it as a variable
...
scrape.it <- function(the_year, the_facility){
  ...
  #Sys.sleep(1) #uncomment this if you are doing bulk scraping! This pauses the reiteration for x seconds (1 second in this case)
...
the_dfs <- lapply(X = the_years, #(2/3)for each argument in this array
                  FUN = scrape.it, #(1/3)FUN means repeat this function
                  the_facility=my_facility) #(3/3)sets the second variable
