...
#6
write.csv(EPAair_O3_NC18_Processed,row.names = FALSE, file ="./Data/Processed/EPAair_O3_NC2018_Processed.csv")
write.csv(EPAair_O3_NC19_Processed,row.names = FALSE, file ="./Data/Processed/EPAair_O3_NC2019_Processed.csv")
write.csv(EPAair_PM25_NC18_Processed,row.names = FALSE, file ="./Data/Processed/EPAair_PM25_NC2018_Processed.csv")
write.csv(EPAair_PM25_NC19_Processed,row.names = FALSE, file ="./Data/Processed/EPAair_PM25_NC2019_Processed.csv")
```
...
```{r}
#7
EPAair_Full <- rbind(EPAair_O3_NC18_Processed,EPAair_O3_NC19_Processed,EPAair_PM25_NC18_Processed,EPAair_PM25_NC19_Processed)
...
#9
EPAair_O3_PM25_NC1819_Processed <- pivot_wider(EPAair_Full_Processed,names_from = AQS_PARAMETER_DESC, values_from = AQI)
