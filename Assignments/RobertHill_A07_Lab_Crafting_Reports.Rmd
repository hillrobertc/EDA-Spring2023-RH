...
|**Name**   |**Value**                          |
|----------:|:----------------------------------|
|Source|EPA Aie Qualirt SYstem (AQS)|
|Date|2018-2019|
...
library(knitr)
kable(summary_PM25, caption = "Mean Particulates (2.5mm)", col.names = 
        c("Country", "$\\mu g/m^3$"))
kable(summary_Ozone, caption = "Mean Ozone", col.names = 
        c("Country", "$\\mu g/m^3$"))
...
```{r, Ozone18, warning=F, fig.cap="Monthly Ozone, 2018", fig.height=3, echo=FALSE}
...
```{r, Ozone19, warning=F, fig.cap="Monthly Ozone, 2019", fig.height=3, echo=FALSE}
...
### Git Repository
https://github.com/hillrobertc/EDA-Spring2023-RH
