...
> Answer: neonicotinoids are ach receptor antagonist and leads to paralysis (and inevitably death) of insect. It isn't toxic to mammals, however it is very persistent in the environment. As such, we care about its ecotoxicology on insects so that we may make recommendations minimize the amount used to reduce the amount remaining persistently in the envionrment. 
