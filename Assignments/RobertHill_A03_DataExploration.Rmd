...
```{r}
#create a frequency line graph of studies over time, seperated based on testing environment
ggplot(Neonics) +
...
> Answer: 'unique' provides information regarding the number of unique values while 'summary' only lists the unique values, requiring us to count how many unique values ourselves.
